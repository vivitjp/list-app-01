...
const MoreCallback: React.FC = () => {
  ...
  if (tmpHandleClickCB !== handleClickCB) { console.log("double CB Only Once") }
  ...
  if (tmpHandleClick2 !== handleClick2) { console.log("handleClick2") }
